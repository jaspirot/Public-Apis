...
namespace Sherweb.Apis.ServiceProvider.Models
{
    ...
    public partial class SubscriptionsNotFoundProblemDetails : ProblemDetails
    {
        /// <summary>
        /// Initializes a new instance of the
        /// SubscriptionsNotFoundProblemDetails class.
        /// </summary>
        public SubscriptionsNotFoundProblemDetails()
        {
            CustomInit();
        }
        ...
        /// a problem type.
        /// </param>
        public SubscriptionsNotFoundProblemDetails(string type = default(string), string title = default(string), int? status = default(int?), string detail = default(string), string instance = default(string), IDictionary<string, object> extensions = default(IDictionary<string, object>))
