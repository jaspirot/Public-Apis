...
namespace Sherweb.Apis.ServiceProvider.Models
{
    ...
    /// </summary>
    public partial class ProductMinimumQuantityDependenciesProblemDetails
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ProductMinimumQuantityDependenciesProblemDetails class.
        /// </summary>
        public ProductMinimumQuantityDependenciesProblemDetails()
        {
            CustomInit();
        }
        ...
        /// a problem type.
        /// </param>
        public ProductMinimumQuantityDependenciesProblemDetails(string type = default(string), string title = default(string), int? status = default(int?), string detail = default(string), string instance = default(string), IDictionary<string, object> extensions = default(IDictionary<string, object>))
        {
            Type = type;
            Title = title;
            Status = status;
