...
namespace Sherweb.Apis.ServiceProvider.Models
{
    ...
    /// <summary>
    /// A constraint between products is not respected.
    /// </summary>
    public partial class ProductMaximumQuantityDependenciesProblemDetails
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ProductMaximumQuantityDependenciesProblemDetails class.
        /// </summary>
        public ProductMaximumQuantityDependenciesProblemDetails()
        {
            CustomInit();
        }
        ...
        /// a problem type.
        /// </param>
        public ProductMaximumQuantityDependenciesProblemDetails(string type = default(string), string title = default(string), int? status = default(int?), string detail = default(string), string instance = default(string), IDictionary<string, object> extensions = default(IDictionary<string, object>))
        {
            Type = type;
            Title = title;
            Status = status;
