...
namespace Sherweb.Apis.ServiceProvider.Models
{
    ...
    public partial class UnpurchasableProductForCustomerProblemDetails
    {
        /// <summary>
        /// Initializes a new instance of the
        /// UnpurchasableProductForCustomerProblemDetails class.
        /// </summary>
        public UnpurchasableProductForCustomerProblemDetails()
        {
            CustomInit();
        }
        ...
        /// a problem type.
        /// </param>
        public UnpurchasableProductForCustomerProblemDetails(string type = default(string), string title = default(string), int? status = default(int?), string detail = default(string), string instance = default(string), IDictionary<string, object> extensions = default(IDictionary<string, object>))
        {
            Type = type;
            Title = title;
            Status = status;
