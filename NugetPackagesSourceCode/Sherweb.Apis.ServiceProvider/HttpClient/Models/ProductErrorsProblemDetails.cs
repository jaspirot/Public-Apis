...
namespace Sherweb.Apis.ServiceProvider.Models
{
    ...
    public partial class ProductErrorsProblemDetails : ProblemDetails
    {
        /// <summary>
        /// Initializes a new instance of the ProductErrorsProblemDetails
        /// class.
        /// </summary>
        public ProductErrorsProblemDetails()
        {
            CustomInit();
        }
        ...
        /// a problem type.
        /// </param>
        public ProductErrorsProblemDetails(string type = default(string), string title = default(string), int? status = default(int?), string detail = default(string), string instance = default(string), IDictionary<string, object> extensions = default(IDictionary<string, object>), string prop = default(string))
