...
namespace Sherweb.Apis.ServiceProvider.Models
{
    ...
    /// <summary>
    /// A provisioning constraint was not satisfied.
    /// </summary>
    public partial class PlansToProvisionErrorsProblemDetails
    {
        /// <summary>
        /// Initializes a new instance of the
        /// PlansToProvisionErrorsProblemDetails class.
        /// </summary>
        public PlansToProvisionErrorsProblemDetails()
        {
            CustomInit();
        }
        ...
        /// a problem type.
        /// </param>
        public PlansToProvisionErrorsProblemDetails(string type = default(string), string title = default(string), int? status = default(int?), string detail = default(string), string instance = default(string), IDictionary<string, object> extensions = default(IDictionary<string, object>))
        {
            Type = type;
            Title = title;
            Status = status;
