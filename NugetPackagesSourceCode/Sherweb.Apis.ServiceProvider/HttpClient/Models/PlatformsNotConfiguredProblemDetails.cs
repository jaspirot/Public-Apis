...
namespace Sherweb.Apis.ServiceProvider.Models
{
    ...
    public partial class PlatformsNotConfiguredProblemDetails : ProblemDetails
    {
        /// <summary>
        /// Initializes a new instance of the
        /// PlatformsNotConfiguredProblemDetails class.
        /// </summary>
        public PlatformsNotConfiguredProblemDetails()
        {
            CustomInit();
        }
        ...
        /// a problem type.
        /// </param>
        public PlatformsNotConfiguredProblemDetails(string type = default(string), string title = default(string), int? status = default(int?), string detail = default(string), string instance = default(string), IDictionary<string, object> extensions = default(IDictionary<string, object>))
