...
namespace Sherweb.Apis.ServiceProvider.Models
{
    ...
    /// <summary>
    /// Combination of some products is not valid.
    /// </summary>
    public partial class ProductCombinationConstraintViolationsProblemDetails
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ProductCombinationConstraintViolationsProblemDetails class.
        /// </summary>
        public ProductCombinationConstraintViolationsProblemDetails()
        {
            CustomInit();
        }
        ...
        /// a problem type.
        /// </param>
        public ProductCombinationConstraintViolationsProblemDetails(string type = default(string), string title = default(string), int? status = default(int?), string detail = default(string), string instance = default(string), IDictionary<string, object> extensions = default(IDictionary<string, object>))
        {
            Type = type;
            Title = title;
            Status = status;
