...
namespace Sherweb.Apis.ServiceProvider.Models
{
    ...
    /// </summary>
    public partial class TermsOfServicesViolationsProblemDetails
    {
        /// <summary>
        /// Initializes a new instance of the
        /// TermsOfServicesViolationsProblemDetails class.
        /// </summary>
        public TermsOfServicesViolationsProblemDetails()
        {
            CustomInit();
        }
        ...
        /// a problem type.
        /// </param>
        public TermsOfServicesViolationsProblemDetails(string type = default(string), string title = default(string), int? status = default(int?), string detail = default(string), string instance = default(string), IDictionary<string, object> extensions = default(IDictionary<string, object>))
        {
            Type = type;
            Title = title;
            Status = status;
