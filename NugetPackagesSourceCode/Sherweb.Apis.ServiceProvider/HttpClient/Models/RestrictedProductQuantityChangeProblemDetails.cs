...
namespace Sherweb.Apis.ServiceProvider.Models
{
    ...
    /// <summary>
    /// The SKU quantity is restricted for purchase.
    /// </summary>
    public partial class RestrictedProductQuantityChangeProblemDetails
    {
        /// <summary>
        /// Initializes a new instance of the
        /// RestrictedProductQuantityChangeProblemDetails class.
        /// </summary>
        public RestrictedProductQuantityChangeProblemDetails()
        {
            CustomInit();
        }
        ...
        /// a problem type.
        /// </param>
        public RestrictedProductQuantityChangeProblemDetails(string type = default(string), string title = default(string), int? status = default(int?), string detail = default(string), string instance = default(string), IDictionary<string, object> extensions = default(IDictionary<string, object>))
        {
            Type = type;
            Title = title;
            Status = status;
