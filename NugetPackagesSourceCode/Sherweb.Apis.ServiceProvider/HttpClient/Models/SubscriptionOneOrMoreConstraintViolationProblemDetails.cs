...
namespace Sherweb.Apis.ServiceProvider.Models
{
    ...
    /// <summary>
    /// A subscription requires at least one of another subscription.
    /// </summary>
    public partial class SubscriptionOneOrMoreConstraintViolationProblemDetails
    {
        /// <summary>
        /// Initializes a new instance of the
        /// SubscriptionOneOrMoreConstraintViolationProblemDetails class.
        /// </summary>
        public SubscriptionOneOrMoreConstraintViolationProblemDetails()
        {
            CustomInit();
        }
        ...
        /// a problem type.
        /// </param>
        public SubscriptionOneOrMoreConstraintViolationProblemDetails(string type = default(string), string title = default(string), int? status = default(int?), string detail = default(string), string instance = default(string), IDictionary<string, object> extensions = default(IDictionary<string, object>))
        {
            Type = type;
            Title = title;
            Status = status;
