...
namespace Sherweb.Apis.ServiceProvider.Models
{
    ...
    public partial class ResourceAllocationTokenNotProvidedProblemDetails : ProblemDetails
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ResourceAllocationTokenNotProvidedProblemDetails class.
        /// </summary>
        public ResourceAllocationTokenNotProvidedProblemDetails()
        {
            CustomInit();
        }
        ...
        /// a problem type.
        /// </param>
        public ResourceAllocationTokenNotProvidedProblemDetails(string type = default(string), string title = default(string), int? status = default(int?), string detail = default(string), string instance = default(string), IDictionary<string, object> extensions = default(IDictionary<string, object>))
            : base(type, title, status, detail, instance, extensions)
        {
            CustomInit();
        }
