...
namespace Sherweb.Apis.ServiceProvider.Models
{
    ...
    /// <summary>
    /// The quantity cannot be decreased because it is on a commitment. Please
    /// contact us to have it adjusted. A penalty may apply.
    /// </summary>
    public partial class CommitmentTermViolationsProblemDetails
    {
        /// <summary>
        /// Initializes a new instance of the
        /// CommitmentTermViolationsProblemDetails class.
        /// </summary>
        public CommitmentTermViolationsProblemDetails()
        {
            CustomInit();
        }
        ...
        /// a problem type.
        /// </param>
        public CommitmentTermViolationsProblemDetails(string type = default(string), string title = default(string), int? status = default(int?), string detail = default(string), string instance = default(string), IDictionary<string, object> extensions = default(IDictionary<string, object>))
        {
            Type = type;
            Title = title;
            Status = status;
