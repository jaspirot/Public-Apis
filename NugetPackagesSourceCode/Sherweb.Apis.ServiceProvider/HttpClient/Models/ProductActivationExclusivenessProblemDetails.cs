...
namespace Sherweb.Apis.ServiceProvider.Models
{
    ...
    /// </summary>
    public partial class ProductActivationExclusivenessProblemDetails
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ProductActivationExclusivenessProblemDetails class.
        /// </summary>
        public ProductActivationExclusivenessProblemDetails()
        {
            CustomInit();
        }
        ...
        /// a problem type.
        /// </param>
        public ProductActivationExclusivenessProblemDetails(string type = default(string), string title = default(string), int? status = default(int?), string detail = default(string), string instance = default(string), IDictionary<string, object> extensions = default(IDictionary<string, object>))
        {
            Type = type;
            Title = title;
            Status = status;
