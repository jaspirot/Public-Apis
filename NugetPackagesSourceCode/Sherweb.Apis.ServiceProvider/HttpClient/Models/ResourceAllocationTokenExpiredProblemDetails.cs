...
namespace Sherweb.Apis.ServiceProvider.Models
{
    ...
    public partial class ResourceAllocationTokenExpiredProblemDetails : ProblemDetails
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ResourceAllocationTokenExpiredProblemDetails class.
        /// </summary>
        public ResourceAllocationTokenExpiredProblemDetails()
        {
            CustomInit();
        }
        ...
        /// a problem type.
        /// </param>
        public ResourceAllocationTokenExpiredProblemDetails(string type = default(string), string title = default(string), int? status = default(int?), string detail = default(string), string instance = default(string), IDictionary<string, object> extensions = default(IDictionary<string, object>))
