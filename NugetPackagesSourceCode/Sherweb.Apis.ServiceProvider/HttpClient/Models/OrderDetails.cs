...
namespace Sherweb.Apis.ServiceProvider.Models
{
    ...
    public partial class OrderDetails : ProblemDetails
    {
        /// <summary>
        ...
        /// a problem type.
        /// </param>
        public OrderDetails(string type = default(string), string title = default(string), int? status = default(int?), string detail = default(string), string instance = default(string), IDictionary<string, object> extensions = default(IDictionary<string, object>), string temp = default(string))
