...
namespace Sherweb.Apis.ServiceProvider.Models
{
    ...
    public partial class NonPositiveAmendmentQuantityProblemDetails : ProblemDetails
    {
        /// <summary>
        /// Initializes a new instance of the
        /// NonPositiveAmendmentQuantityProblemDetails class.
        /// </summary>
        public NonPositiveAmendmentQuantityProblemDetails()
        {
            CustomInit();
        }
        ...
        /// a problem type.
        /// </param>
        public NonPositiveAmendmentQuantityProblemDetails(string type = default(string), string title = default(string), int? status = default(int?), string detail = default(string), string instance = default(string), IDictionary<string, object> extensions = default(IDictionary<string, object>))
