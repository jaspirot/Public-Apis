...
namespace Sherweb.Apis.ServiceProvider.Models
{
    ...
    /// <summary>
    /// The provided quantity for the SKU is invalid.
    /// </summary>
    public partial class SubscriptionsValidationErrorProblemDetails
    {
        /// <summary>
        /// Initializes a new instance of the
        /// SubscriptionsValidationErrorProblemDetails class.
        /// </summary>
        public SubscriptionsValidationErrorProblemDetails()
        {
            CustomInit();
        }
        ...
        /// a problem type.
        /// </param>
        public SubscriptionsValidationErrorProblemDetails(string type = default(string), string title = default(string), int? status = default(int?), string detail = default(string), string instance = default(string), IDictionary<string, object> extensions = default(IDictionary<string, object>))
        {
            Type = type;
            Title = title;
            Status = status;
