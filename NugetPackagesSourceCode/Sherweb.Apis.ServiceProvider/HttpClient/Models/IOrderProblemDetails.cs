...
namespace Sherweb.Apis.ServiceProvider.Models
{
    ...
    public partial class IOrderProblemDetails
    {
        /// <summary>
        /// Initializes a new instance of the IOrderProblemDetails class.
        /// </summary>
        public IOrderProblemDetails()
        {
            CustomInit();
        }
        ...
        /// a problem type.
        /// </param>
        public IOrderProblemDetails(string type = default(string), string title = default(string), int? status = default(int?), string detail = default(string), string instance = default(string), IDictionary<string, object> extensions = default(IDictionary<string, object>))
        {
            Type = type;
            Title = title;
            Status = status;
