...
namespace Sherweb.Apis.ServiceProvider.Models
{
    ...
    /// </summary>
    public partial class ProductActivationDependenciesProblemDetails
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ProductActivationDependenciesProblemDetails class.
        /// </summary>
        public ProductActivationDependenciesProblemDetails()
        {
            CustomInit();
        }
        ...
        /// a problem type.
        /// </param>
        public ProductActivationDependenciesProblemDetails(string type = default(string), string title = default(string), int? status = default(int?), string detail = default(string), string instance = default(string), IDictionary<string, object> extensions = default(IDictionary<string, object>))
        {
            Type = type;
            Title = title;
            Status = status;
