...
namespace Sherweb.Apis.ServiceProvider.Models
{
    ...
    public partial class SubscriptionsAlreadyExistsProblemDetails
    {
        /// <summary>
        /// Initializes a new instance of the
        /// SubscriptionsAlreadyExistsProblemDetails class.
        /// </summary>
        public SubscriptionsAlreadyExistsProblemDetails()
        {
            CustomInit();
        }
        ...
        /// a problem type.
        /// </param>
        public SubscriptionsAlreadyExistsProblemDetails(string type = default(string), string title = default(string), int? status = default(int?), string detail = default(string), string instance = default(string), IDictionary<string, object> extensions = default(IDictionary<string, object>))
        {
            Type = type;
            Title = title;
            Status = status;
